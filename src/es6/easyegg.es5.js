...
function on(code, cb) {
  ...
  var resetSequence = function resetSequence() {
    sequence = [];
    index = 0;
  };
  ...
  var lacksKeyName = function lacksKeyName(c) {
  ...
  if (lacksKeyName(code)) {
    ...
    if (codeMap[code]) {
      var registeredCode = codeMap[code];
  ...
  document.addEventListener('keyup', function (e) {
    ...
    var expected = keycodeMap[button];
...
//# sourceMappingURL=easyegg.es5.js.map